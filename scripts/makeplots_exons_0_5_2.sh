...
/home/wyleung/.virtualenvs/project-051-rnaveer/bin/sashimi_plot --plot-event $EVENT ../newdeps_single/veer_selected/ veer_selected_exons_0.5.2/sashimi_plot_settings.txt --output-dir veer_selected_exons_0.5.2/plot;
